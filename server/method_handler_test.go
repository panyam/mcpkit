...
func TestCustomMethod_Dispatch(t *testing.T) {
	srv := server.NewServer(core.ServerInfo{Name: "test", Version: "1.0"},
		server.WithMethodHandler("custom/echo", func(ctx context.Context, id json.RawMessage, params json.RawMessage) *core.Response {
...
func TestCustomMethod_UnknownStillReturnsMethodNotFound(t *testing.T) {
	srv := server.NewServer(core.ServerInfo{Name: "test", Version: "1.0"},
		server.WithMethodHandler("custom/known", func(ctx context.Context, id json.RawMessage, params json.RawMessage) *core.Response {
...
func TestCustomMethod_BuiltinOverridePanics(t *testing.T) {
	assert.Panics(t, func() {
		server.NewServer(core.ServerInfo{Name: "test", Version: "1.0"},
			server.WithMethodHandler("tools/list", func(ctx context.Context, id json.RawMessage, params json.RawMessage) *core.Response {
...
func TestCustomMethod_RequiresInitialized(t *testing.T) {
	srv := server.NewServer(core.ServerInfo{Name: "test", Version: "1.0"},
		server.WithMethodHandler("custom/test", func(ctx context.Context, id json.RawMessage, params json.RawMessage) *core.Response {
			return core.NewResponse(id, "ok")
		}),
	)
...
func TestCustomMethod_HandleMethod(t *testing.T) {
	srv := server.NewServer(core.ServerInfo{Name: "test", Version: "1.0"})
	srv.HandleMethod("custom/dynamic", func(ctx context.Context, id json.RawMessage, params json.RawMessage) *core.Response {
...
func TestCustomMethod_ForAllTransports(t *testing.T) {
	srv := server.NewServer(core.ServerInfo{Name: "test", Version: "1.0"},
		server.WithMethodHandler("custom/ping", func(ctx context.Context, id json.RawMessage, params json.RawMessage) *core.Response {
