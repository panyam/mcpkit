...
func TestTaskFullLifecycle(t *testing.T) {
	...
	created, err := client.ToolCallAsTaskV1(t.Context(), c, "slow", map[string]any{"data": "hello"})
	if err != nil {
	...
	got, err := client.GetTaskV1(t.Context(), c, created.Task.TaskID)
	if err != nil {
	...
	list, err := client.ListTasksV1(t.Context(), c, "")
	if err != nil {
	...
	result, taskID, err := client.GetTaskPayloadV1(t.Context(), c, created.Task.TaskID)
	if err != nil {
...
func TestTaskCancel(t *testing.T) {
	...
	created, err := client.ToolCallAsTaskV1(t.Context(), c, "slow", map[string]any{"data": "cancel-me"})
	if err != nil {
		t.Fatal(err)
	}

	cancelled, err := client.CancelTaskV1(t.Context(), c, created.Task.TaskID)
	if err != nil {
...
func TestTaskFailedTool(t *testing.T) {
	...
	created, err := client.ToolCallAsTaskV1(t.Context(), c, "fail-async", nil)
	if err != nil {
		t.Fatal(err)
	}
...
func TestTaskNoHintRunsSync(t *testing.T) {
	...
	text, err := c.ToolCall(t.Context(), "echo", map[string]any{"message": "hi"})
	if err != nil {
		t.Fatal(err)
	}
	if text != "echo: hi" {
...
func TestTaskCapabilityAdvertised(t *testing.T) {
	...
	result, err := c.Call(t.Context(), "tasks/list", map[string]any{})
	if err != nil {
...
func TestTaskMultipleConcurrent(t *testing.T) {
	...
	var taskIDs []string
	for i := 0; i < n; i++ {
		created, err := client.ToolCallAsTaskV1(t.Context(), c, "slow", map[string]any{"data": fmt.Sprintf("t%d", i)})
		if err != nil {
			t.Fatal(err)
		}
	...
	for _, id := range taskIDs {
		_, err := client.CancelTaskV1(t.Context(), c, id)
		if err != nil {
...
func TestTaskCustomTTL(t *testing.T) {
	...
	created, err := client.ToolCallAsTaskV1(t.Context(), c, "slow", map[string]any{"data": "x"}, &client.TaskCallOptionsV1{TTL: 60000})
	if err != nil {
		t.Fatal(err)
	}
...
func TestTaskGetNotFound(t *testing.T) {
	...
	_, err := client.GetTaskV1(t.Context(), c, "nonexistent-id")
	if err == nil {
...
func TestTaskCancelAlreadyTerminal(t *testing.T) {
	...
	created, _ := client.ToolCallAsTaskV1(t.Context(), c, "slow", map[string]any{"data": "x"})
	client.CancelTaskV1(t.Context(), c, created.Task.TaskID)

	_, err := client.CancelTaskV1(t.Context(), c, created.Task.TaskID)
	if err == nil {
...
func TestTaskResultAfterCompletion(t *testing.T) {
	...
	created, _ := client.ToolCallAsTaskV1(t.Context(), c, "slow", map[string]any{"data": "done"})

	unblock <- struct{}{}

	var completed bool
	for i := 0; i < 20; i++ {
		got, _ := client.GetTaskV1(t.Context(), c, created.Task.TaskID)
	...
	result, _, err := client.GetTaskPayloadV1(t.Context(), c, created.Task.TaskID)
	if err != nil {
		t.Fatal(err)
	}
...
func TestTaskProgressCounter(t *testing.T) {
	...
	for i := 0; i < n; i++ {
		go func() {
			created, err := client.ToolCallAsTaskV1(t.Context(), c, "slow", map[string]any{"data": "x"})
			if err == nil {
...
func TestTasksGetFlatWireFormat(t *testing.T) {
	...
	created, err := client.ToolCallAsTaskV1(t.Context(), c, "slow", map[string]any{"data": "flat"})
	if err != nil {
		t.Fatal(err)
	}

	result, err := c.Call(t.Context(), "tasks/get", map[string]any{"taskId": created.Task.TaskID})
	if err != nil {
		t.Fatal(err)
	}
...
func TestTasksCancelFlatWireFormat(t *testing.T) {
	...
	result, err := c.Call(t.Context(), "tasks/cancel", map[string]any{"taskId": created.Task.TaskID})
	if err != nil {
		t.Fatal(err)
	}
...
func TestTasksResultRelatedTask(t *testing.T) {
	...
	created, _ := client.ToolCallAsTaskV1(t.Context(), c, "slow", map[string]any{"data": "meta"})
	unblock <- struct{}{}
	...
	result, err := c.Call(t.Context(), "tasks/result", map[string]any{"taskId": created.Task.TaskID})
	if err != nil {
		t.Fatal(err)
	}
...
func TestTaskPanicRecovery(t *testing.T) {
	...
	created, err := client.ToolCallAsTaskV1(t.Context(), c, "panic-tool", nil)
	if err != nil {
		t.Fatal(err)
	}
...
func TestTaskResultForFailedTask(t *testing.T) {
	...
	result, relatedID, err := client.GetTaskPayloadV1(t.Context(), c, created.Task.TaskID)
	if err != nil {
...
func TestGetTaskContextNilForSync(t *testing.T) {
	...
	_, err := c.ToolCall(t.Context(), "check-ctx", nil)
	if err != nil {
		t.Fatal(err)
	}
	if gotTC {
...
func TestGetTaskContextAvailableForAsync(t *testing.T) {
	...
	created, err := client.ToolCallAsTaskV1(t.Context(), c, "check-ctx", nil)
	if err != nil {
		t.Fatal(err)
	}
...
func TestTaskInputRequiredTransition(t *testing.T) {
	...
	created, err := client.ToolCallAsTaskV1(t.Context(), c, "needs-input", nil)
	if err != nil {
		t.Fatal(err)
	}
...
func TestTaskResultConcurrentCancel(t *testing.T) {
	...
	go func() {
		r, tid, err := client.GetTaskPayloadV1(t.Context(), c, created.Task.TaskID)
...
func TestQueueCleanupOnCancel(t *testing.T) {
	...
	created, err := client.ToolCallAsTaskV1(t.Context(), c, "slow", nil)
	if err != nil {
		t.Fatal(err)
	}
...
func getTaskPayloadOrTimeout(t *testing.T, c *client.Client, taskID string, timeout time.Duration) (*core.ToolResult, string, error) {
	...
	go func() {
		r, id, err := client.GetTaskPayloadV1(t.Context(), c, taskID)
		ch <- payload{r, id, err}
	}()
	select {
	case p := <-ch:
...
func TestTaskElicitE2E(t *testing.T) {
	...
	// Create the task.
	created, err := client.ToolCallAsTaskV1(t.Context(), c, "confirm-action", map[string]any{"action": "deploy"})
	if err != nil {
		t.Fatal(err)
	}
...
func TestTaskSampleE2E(t *testing.T) {
	...
	created, err := client.ToolCallAsTaskV1(t.Context(), c, "write-haiku", map[string]any{"topic": "nature"})
	if err != nil {
		t.Fatal(err)
	}
...
func TestTaskTTLExpiryE2E(t *testing.T) {
	...
	for i := 0; i < 20; i++ {
		got, err := client.GetTaskV1(t.Context(), c, taskID)
		if err != nil {
	...
	// Task should be gone.
	_, err = client.GetTaskV1(t.Context(), c, taskID)
	if err == nil {
...
func TestTaskProgressFromBackgroundNoPanic(t *testing.T) {
	...
	created, err := client.ToolCallAsTaskV1(t.Context(), c, "progress-tool", nil)
	if err != nil {
		t.Fatal(err)
	}
...
func TestTaskCancelStopsGoroutine(t *testing.T) {
	...
	created, err := client.ToolCallAsTaskV1(t.Context(), c, "long-task", nil)
	if err != nil {
		t.Fatal(err)
	}
...
func TestTaskStatusNotificationOnComplete(t *testing.T) {
	...
	created, err := client.ToolCallAsTaskV1(t.Context(), c, "fast", nil)
	if err != nil {
		t.Fatal(err)
	}

	// Call tasks/result — this triggers the notification (Option 1).
	client.GetTaskPayloadV1(t.Context(), c, created.Task.TaskID)
...
func TestTaskStatusNotificationOnCancel(t *testing.T) {
	...
	created, err := client.ToolCallAsTaskV1(t.Context(), c, "blocking", nil)
	if err != nil {
		t.Fatal(err)
	}
...
func TestTaskDoubleCompletionRejected(t *testing.T) {
	...
	result1, _, err := client.GetTaskPayloadV1(t.Context(), c, created.Task.TaskID)
	if err != nil {
		t.Fatal(err)
	}
	...
	result2, _, err := client.GetTaskPayloadV1(t.Context(), c, created.Task.TaskID)
	if err != nil {
		t.Fatal(err)
	}
...
func TestWaitForTaskCompletes(t *testing.T) {
	...
	created, err := client.ToolCallAsTaskV1(t.Context(), c, "slow", map[string]any{"data": "wait"})
	if err != nil {
		t.Fatal(err)
	}
...
func TestWaitForTaskCancelled(t *testing.T) {
	...
	created, err := client.ToolCallAsTaskV1(t.Context(), c, "slow", map[string]any{"data": "wait-cancel"})
	if err != nil {
		t.Fatal(err)
	}
...
func TestToolCallAsTaskWithProgressToken(t *testing.T) {
	...
	_, err := client.ToolCallAsTaskV1(t.Context(), c, "token-check", nil, &client.TaskCallOptionsV1{
...
func TestToolCallAsTaskWithPollInterval(t *testing.T) {
	...
	created, err := client.ToolCallAsTaskV1(t.Context(), c, "slow", map[string]any{"data": "x"}, &client.TaskCallOptionsV1{
		PollInterval: 2000,
	})
	if err != nil {
		t.Fatal(err)
...
func TestWaitForTaskTimeout(t *testing.T) {
	...
	created, err := client.ToolCallAsTaskV1(t.Context(), c, "slow", map[string]any{"data": "stuck"})
	if err != nil {
		t.Fatal(err)
	}
