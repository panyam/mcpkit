...
| **Sub-agents (agent-as-tool)** | ✅ #941,#942,#943,#1031,#1033,#1042 | `agent/agent_source.go` (`AgentSource`, depth+budget caps), `SubAgentEvent` nesting, `agent/team.go` (`Team` handoff + host-wired `Config.Team`/`Team.RunTurn`, #1042), `agent/fanout_source.go` (`FanOutSource` concurrent broadcast, #1033), declarative host personas | tree budget #1032, async/task #1035, upward signals #1036, dynamic catalog #1038, nested config #1043, structured I/O + map-fan-out (#1033 remainder), interaction mediator #1157 |
