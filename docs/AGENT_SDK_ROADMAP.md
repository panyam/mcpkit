...
| **Sub-agents (agent-as-tool)** | ✅ #941,#942,#943,#1031,#1032,#1033,#1035,#1042 | `agent/agent_source.go` (`AgentSource`, depth+budget caps, structured I/O), `agent/async_agent_source.go` (`AsyncAgentSource` Task form, #1035), `agent/fanout_source.go` (`FanOutSource`, #1033), `agent/team.go` (`Team` handoff + host wiring + tagging, #1042), `agent/tree_budget.go` (`TreeBudget` aggregate cap, #1032), `SubAgentEvent` nesting, declarative host personas | upward signals + interruptible turn #1036, dynamic catalog #1038, nested config #1043, interaction mediator #1157, map-style fan-out (unfiled) |
...
- **Sub-agent composition:** upward signals / runner-control meta-tools + interruptible turn #1036, dynamic agent catalog
