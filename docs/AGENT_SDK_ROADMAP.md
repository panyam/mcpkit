...
| **Sub-agents (agent-as-tool)** | ✅ #941,#942,#943,#1031,#1033,#1042 | `agent/agent_source.go` (`AgentSource`, depth+budget caps, structured I/O), `SubAgentEvent` nesting, `agent/team.go` (`Team` handoff + host-wired `Config.Team`/`Team.RunTurn` + per-agent event tagging, #1042), `agent/fanout_source.go` (`FanOutSource` concurrent broadcast, #1033), declarative host personas | tree budget #1032, async/task #1035, upward signals #1036, dynamic catalog #1038, nested config #1043, interaction mediator #1157, map-style fan-out (unfiled) |
...
- **Sub-agent composition:** aggregate tree budget #1032 (fan-out + structured I/O + Team tagging #1033 shipped),
