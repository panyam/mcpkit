...
// DefaultChannelPrefix re-exports the root constant so call sites
// don't need to import two packages. Same value.
const DefaultChannelPrefix = rootredis.DefaultChannelPrefix
