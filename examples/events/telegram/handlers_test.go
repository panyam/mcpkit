...
func TestWebhookHMACSignature_MCPHeaders(t *testing.T) {
	...
	webhooks.Register(events.RegisterParams{CanonicalKey: []byte("hmac-test"), DerivedID: "sub_hmac_test", URL: srv.URL, Secret: secret, MaxAgeMs: 0})
...
func TestWebhookKeyedByCanonicalTuple(t *testing.T) {
	...
	webhooks.Register(events.RegisterParams{CanonicalKey: keyB, DerivedID: "sub_bob", URL: "http://example.com/hook", Secret: "whsec_secret-2", MaxAgeMs: 0})
