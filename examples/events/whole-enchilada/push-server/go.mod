module github.com/panyam/mcpkit/examples/events/whole-enchilada/push-server
...
require github.com/panyam/mcpkit/experimental/ext/events/clients/go v0.0.0
...
require (
	...
	github.com/panyam/mcpkit v0.2.40 // indirect
