module github.com/panyam/mcpkit/examples/events/whole-enchilada/event-server
...
require (
	...
	github.com/panyam/demokit v0.0.29 // indirect
	...
	github.com/panyam/oneauth v0.1.17 // indirect
