module github.com/panyam/mcpkit/examples/agents/deep-agent-supervisor/server
...
require (
	...
	github.com/panyam/demokit v0.0.31 // indirect
...
replace github.com/panyam/mcpkit/examples/common => ../../../../examples/common
