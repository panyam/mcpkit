// Drop-in mcpkit equivalent of upstream's basic-server-preact example.
//
...
// cloned upstream and run `npm run build` for basic-server-preact.
//
...
func main() {
	...
	htmlPath := filepath.Join(extAppsDir, "examples", "basic-server-preact", "dist", "mcp-app.html")
