// Drop-in mcpkit equivalent of upstream's basic-server-react example.
//
...
// cloned upstream and run `npm run build` for basic-server-react.
//
...
func main() {
	...
	htmlPath := filepath.Join(extAppsDir, "examples", "basic-server-react", "dist", "mcp-app.html")
