...
> **Reachable from:** [request-anatomy](./request-anatomy.md) Next-to-read, [mrtr](./mrtr.md) Next-to-read
...
- Migration to MRTR: when legacy middleware should move and when it shouldn't

## Next to read

- **[MRTR](./mrtr.md)** *(stub branch)* — the unified routing layer that mcpkit is moving toward.
